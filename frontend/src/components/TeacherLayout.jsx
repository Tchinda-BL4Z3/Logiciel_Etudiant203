...
import { 
  ...
  Search, Bell, Settings, LogOut, AlertCircle 
} from 'lucide-react';
...
const TeacherLayout = ({ children }) => {
  ...
  // --- FONCTION DÉCLENCHÉE APRÈS CONFIRMATION ---
  const confirmLogout = () => {
    ...
    <div className="flex h-screen bg-[#F1F5F9]">
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-slate-900/60 backdrop-blur-md animate-in fade-in duration-300">
            <div className="bg-white rounded-[32px] p-10 max-w-sm w-full shadow-2xl border border-slate-100 text-center animate-in zoom-in-95 duration-300">
                ...
                <p className="text-slate-400 text-sm font-medium leading-relaxed mb-8">
                    Êtes-vous sûr de vouloir quitter votre portail enseignant ?
                </p>
